...
public interface PayService {
     ...
     * @return 查询结果
     */
    Result<TradeQueryResponse> query(@NotNull(message = "The request can't be null.") TradeQueryRequest request);
     ...
     * @return 撤销结果
     */
    Result<TradeCancelResponse> cancel(@NotNull(message = "The request can't be null.") TradeCancelRequest request);
     ...
     * @return 退款结果
     */
    Result<TradeRefundResponse> refund(@NotNull(message = "The request can't be null.") TradeRefundRequest request);
}
